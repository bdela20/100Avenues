  ...
  return (
    <div>
      ...
      <div style={styles.headerSection}>
        <img
          src="src/assets/Hotels/Poseidon/banner.webp"
...
Discover the timeless elegance of Hotel Poseidon, a jewel nestled 
in the verdant embrace of Positano, with an exclusive vantage 
point overlooking the storied "vertical village" and the mesmerizing 
Amalfi Coast. Celebrate the legacy of a former Mediterranean villa 
transformed into a sanctuary of luxury, where more than 60 years of 
the Aonzo family's passion for discreet and sophisticated hospitality 
comes to life. At this gorgeous boutique hotel, you can experience the 
epitome of Italian charm, where every staff member curates an ambiance 
of warmth and familiarity, inviting you to make our history a part of your unforgettable story.
          </p>
        </div>
        <div style={{ flex: '1' }}>
          <img
            src="src/assets/Hotels/Poseidon/overview.webp"
...
<section style={styles.featuresSection}>
  <h2 style={styles.featuresHeading}>45 Suites & Villas | 1 Floors | 2 Restaurants</h2>
  <div style={styles.featuresContainer}>
    ...
    <div style={styles.featuresColumn}>
      ...
      <li style={{ ...styles.featureItem, listStyleType: 'disc' }}>Valet parking</li>
...
Nestled atop the hotel's terrace, "Il Tridente" Bar offers 
patrons a breathtaking vista of Positano, one of the town's finest. 
As evening descends, a gentle glow from soft lights and candles bathes creating an enchanting atmosphere.
<p>This is the quintessential setting for unwinding with a skillfully crafted cocktail in hand, accompanied 
  by a chef's special appetizer of the day. The interior echoes a classic Neapolitan sitting room, complete 
  with two fireplaces that provide a warm embrace on cooler days.</p>
      </p>
    </div>
    <img
      src="src/assets/Hotels/Poseidon/highliths.webp"
...
<section style={styles.activitiesSection}>
  ...
  <div style={styles.activitiesList}>
    <div style={styles.activitiesColumn}>
      <li style={{ ...styles.activitiesItem, listStyleType: 'disc' }}>Beach</li>
      ...
      <li style={{ ...styles.activitiesItem, listStyleType: 'disc' }}>Golf course</li>
      <li style={{ ...styles.activitiesItem, listStyleType: 'disc' }}>Scuba Diving</li>
    </div>
    <div style={styles.activitiesColumn}>
      <li style={{ ...styles.activitiesItem, listStyleType: 'disc' }}>Shooping Mall/Area</li>
      <li style={{ ...styles.activitiesItem, listStyleType: 'disc' }}>Snorkeling</li>
      <li style={{ ...styles.activitiesItem, listStyleType: 'disc' }}>Outdoor Tennis</li>
      <li style={{ ...styles.activitiesItem, listStyleType: 'disc' }}>Water Skiing</li>
      <li style={{ ...styles.activitiesItem, listStyleType: 'disc' }}>Scooter tours</li>
    </div>
  </div>
</section>
...
<section style={styles.quoteSection}>
  ...
  <p>Interested in making a reservation at Hotel Poseidon? Reach out to us below.</p>
