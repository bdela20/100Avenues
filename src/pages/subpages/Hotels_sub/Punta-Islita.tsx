  ...
  return (
    <div>
      ...
      <div style={styles.headerSection}>
        <img
          src="src/assets/Hotels/punta-islita-main2.webp"
      ...
      <section style={styles.overviewSection}>
        <div style={{ flex: '1', paddingRight: '20px' }}>
          ...
          Punta Islita, located on Guanacaste's enchanting coastline, 
          offers an immersive experience enriched by local wisdom, 
          vibrant rainforests, and pristine beaches. Guests can explore 
          the diverse wildlife, engage in various outdoor activities, 
          and experience the region's Blue Zone lifestyle. 
          The terraced design of Punta Islita provides unmatched views 
          from each room, exceptional dining at Alma & Aura Restaurants 
          using local ingredients, top-tier amenities, and the Nanku Spa's 
          traditional healing rituals passed down from the Chorotega ancestors.
          Ideal for extended stays and family gatherings, the resort's Villas 
          capture the essence of Pura Vida and the authentic spirit of Costa Rica.
          </p>
        </div>
        <div style={{ flex: '1' }}>
          <img
...
<section style={styles.highlightsSection}>
  ...
  <em>The Perfect Location in a Blue Zone!</em>
      ...
      <p>
        From its inception, Punta Islita has maintained a 
        deep connection with its local community. Situated in 
        one of the five global Blue Zone regions, the community 
        of Punta Islita possesses a wealth of knowledge to impart. 
        Engage with and understand the harmonious Blue Zone 
        lifestyle through activities such as sustainable cooking 
        lessons and craft workshops, and carry a piece of this 
        balanced life philosophy back home with you.
      </p>
    </div>
    <img
...
<section style={styles.activitiesSection}>
  ...
  <div style={styles.activitiesList}>
    <div style={styles.activitiesColumn}>
      ...
      <li style={{ ...styles.activitiesItem, listStyleType: 'disc' }}>Spa</li>
      <li style={{ ...styles.activitiesItem, listStyleType: 'disc' }}>Nature walks</li>
      <li style={{ ...styles.activitiesItem, listStyleType: 'disc' }}>Dusk hiking</li>
      <li style={{ ...styles.activitiesItem, listStyleType: 'disc' }}>Monkey hike</li>
    </div>
    <div style={styles.activitiesColumn}>
      ...
      <li style={{ ...styles.activitiesItem, listStyleType: 'disc' }}>Surfing lessons</li>
...
<section style={styles.quoteSection}>
  ...
  <p>Interested in making a reservation at Punta Islita? Reach out to us below.</p>
