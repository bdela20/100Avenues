...
function NewfoundSisterhood() {
  const backgroundImageUrl = 'src/assets/Retreats/Home/ArtBreathwork/Banner.webp';
  const image1Url = 'src/assets/Retreats/Home/ArtBreathwork/Face.webp';
  const image2Url = 'src/assets/Retreats/Home/ArtBreathwork/body.webp';
...
<div style={{ marginTop: '3rem', textAlign: 'center', maxWidth: '1000px', margin: '0 auto' }}>
  ...
  <div style={{ display: 'flex', gap: '3rem', maxWidth: '1200px', width: '100%', alignItems: 'center' }}>
    ...
    {/* Image Section */}
    <img
      src="src/assets/Retreats/Home/ArtBreathwork/Host.webp"
      alt="Host Image"
...
<section style={{ padding: '3rem', backgroundColor: '#f7f3f1' }}>
    <div style={{ display: 'flex', alignItems: 'center', maxWidth: '1200px', margin: '0 auto', gap: '2rem', flexWrap: 'wrap' }}>
      ...
      <div style={{ flex: '1 1 300px', display: 'flex', justifyContent: 'center' }}>
        <img 
          src="src/assets/Retreats/Home/ArtBreathwork/VIP.webp" 
...
export default NewfoundSisterhood;
